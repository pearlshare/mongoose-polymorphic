...
module.exports = function(schema, options) {
  options || (options = {});
  var associationKey = options.associationKey || 'item';
  var required = options.required || false;
  var capitalizedAssociationKey = associationKey.charAt(0).toUpperCase() + associationKey.slice(1);
  var idKey = "" + associationKey + "Id";
  var typeKey = "" + associationKey + "Type";
